...
$(
  (function() {
    ...
    describe("RSS Feeds", function() {
       ...
       */
      it("has valid feed URLs", function() {
       ...
       */
      it("has valid feed names", function() {
        for (const feed of allFeeds) {
    ...
    describe("Initial Entries", function() {
       ...
       */
      it("has atleast single entry element when the feeds are loaded", function() {
    ...
    describe("New Feed Selection", function() {
      let udacityBlogFeedContent;
      beforeEach(function(done) {
        loadFeed(0, function() {
          /// Storing the first feed.
          udacityBlogFeedContent = $(".feed").html();
          /// Now loading CSS tricks feeds.
          loadFeed(1, done);
        });
      });
      ...
      it("changes content on new feed load", function() {
        expect($(".feed").html()).not.toBe(udacityBlogFeedContent);
      });
    });
  })()
);
